extern crate rs_yara as yara;

use yara::{yara_sys::CompileErrorLevel, Compiler, errors::Error, Metadata, MetadataValue, Rules, Yara};
...
";
    ...
    rules.set_flags(yara::yara_sys::SCAN_FLAGS_FAST_MODE);
